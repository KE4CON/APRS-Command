...
cp "$REPO_ROOT/docs/help/QUICK_START.md" "$STAGING_DIR/QUICK_START.md"
cp "$REPO_ROOT/docs/help/INSTALLATION_GUIDE.md" "$STAGING_DIR/INSTALLATION_GUIDE.md"
cp "$REPO_ROOT/docs/help/SAFETY_AND_TRANSMIT_GUIDE.md" "$STAGING_DIR/SAFETY_AND_TRANSMIT_GUIDE.md"
cp "$REPO_ROOT/docs/help/TROUBLESHOOTING.md" "$STAGING_DIR/TROUBLESHOOTING.md"
cp "$REPO_ROOT/docs/release/RELEASE_NOTES_TEMPLATE.md" "$RELEASE_NOTES_DIR/RELEASE_NOTES_TEMPLATE.md"
