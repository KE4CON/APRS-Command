...
public sealed class JsonAppSettingsStore : IAppSettingsStore
{
    ...
    private static AppSettings Normalize(AppSettings settings)
    {
        ...
        var iGate = settings.IGate ?? IGateSettings.Default;
        var digipeater = settings.Digipeater ?? DigipeaterSettings.Default;
        ...
        var normalized = settings with { Station = station, Connections = connections, IGate = iGate, Digipeater = digipeater, Audio = audio, Windows = windows, Gps = gps, ManagedModem = managedModem, DarkMode = settings.DarkMode, MessageTemplates = settings.MessageTemplates ?? MessageTemplatesSettings.Default };
    ...
    private static AppSettings SalvageLoad(string json)
    {
        ...
        var iGate = TryDeserializeSection(root, "iGate", IGateSettings.Default) ?? IGateSettings.Default;
        var digipeater = TryDeserializeSection(root, "digipeater", DigipeaterSettings.Default) ?? DigipeaterSettings.Default;
        ...
        return Migrate(new AppSettings(schemaVersion, station, connections, iGate, digipeater, audio, windows, gps, managedModem, darkMode, messageTemplates));
    }
